    ...
    <div className="container mx-auto py-6 space-y-6 max-w-4xl">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Self-host automated trading strategies inside TradeYantra. Each strategy runs as an isolated
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  page and copy your TradeYantra API key
                </p>
              </div>
            </div>
            <div className="flex gap-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-5">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Strategies inherit every variable from TradeYantra's <code>.env</code> via{' '}
              <code>os.environ.copy()</code>. The key ones for connecting back to TradeYantra:
            </p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                <thead>
        ...
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionContent className="text-muted-foreground space-y-3">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="bg-muted p-3 rounded-lg">
                    ...
                    <p className="mt-1">
                      Log in to TradeYantra before the session, wait for master contracts to download,
            ...
            <AccordionItem value="resource-limits">
              ...
              <AccordionContent className="text-muted-foreground space-y-3">
                <p>
                  ...
                  TradeYantra. On Windows, these are not enforced at the OS level.
                </p>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse">
                    <thead>
            ...
            <AccordionItem value="restart">
              <AccordionTrigger>What happens if I restart TradeYantra?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground space-y-3">
                <p>TradeYantra handles restarts gracefully:</p>
                <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <AccordionItem value="add-libraries">
              ...
              <AccordionContent className="text-muted-foreground space-y-3">
                <p>
                  If your strategy needs additional Python libraries, install them in TradeYantra's
                  environment.
                </p>
